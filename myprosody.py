...
def myprosody(m,p):
    ...
    """
    sound=p+"/"+"myprosody/"+"dataset"+"/"+"audioFiles"+"/"+m
    sourcerun=p+"/"+"myprosody/"+"dataset"+"/"+"essen"+"/"+"MLTRNL.praat"
    path=p+"/"+"myprosody/"+"dataset"+"/"+"audioFiles"+"/"
    outo=p+"/"+"myprosody/"+"dataset"+"/"+"datanewchi22.csv"
    outst=p+"/"+"myprosody/"+"dataset"+"/"+"datanewchi44.csv"
    outsy=p+"/"+"myprosody/"+"dataset"+"/"+"datanewchi33.csv"
    pa2=p+"/"+"myprosody/"+"dataset"+"/"+"stats.csv"
    pa7=p+"/"+"myprosody/"+"dataset"+"/"+"datanewchi44.csv" 
    ...
    try:
        ...
        for i in range(25):
            ...
            if he == 0:
                ...
                dfout = "%s:\t %f (%s)" % (nsns[i], he, "Out of Range")
                print(dfout)
